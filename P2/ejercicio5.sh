...
cat /proc/mounts | \
sed -r -e 's/^(\/*[[:alpha:]]*\/*[[:alpha:]]*_*-*[0-9]*[[:alpha:]]*)[[:space:]](\/*[[:alpha:]]*\/*[[:alpha:]]*_*-*[[:alpha:]]*\/*[0-9]*[[:alpha:]]*\/*[[:alpha:]]*_*[[:alpha:]]*,*[[:alpha:]]*_*[[:alpha:]]*)[[:space:]]([[:alpha:]]*\.*_*[0-9]*[[:alpha:]]*-*[[:alpha:]]*).*/-> Punto de montaje: \2, Dispositivo: \1, Tipo de dispositivo: \3/'
